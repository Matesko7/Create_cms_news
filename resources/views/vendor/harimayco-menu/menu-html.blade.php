                                ...
                                <div class="wrap">
                                    ...
                                    <div class="manage-menus">
                                        <form method="get" action="{{ $currentUrl }}">
                                            <label for="menu" class="selected-menu">Vyberte si menu ktoré chcete editovať:</label>
                                            ...
                                            <span class="add-new-menu-action"> alebo <a
                                                    href="{{ $currentUrl }}?action=edit&menu=0">Vytvoriť nové</a>.
                                            </span>
                                        </form>
                                    </div>
                                                    ...
                                                    <div class="menu-edit ">
                                                            ...
                                                            <div class="major-publishing-actions">
                                                                ...
                                                                <div class="publishing-action">
                                                                    <a onclick="createnewmenu()" name="save_menu"
                                                                        id="save_menu_header"
                                                                        class="button button-primary menu-save">Vytvoriť menu</a>
                                                                </div>
                                                                @elseif(request()->has("menu"))
                                                                <div class="publishing-action">
                                                                    <a onclick="getmenus()" name="save_menu"
                                                                        id="save_menu_header"
                                                                        class="button button-primary menu-save">Uložiť
                                                                        menu</a>
                                                                ...
                                                                <div class="publishing-action">
                                                                    <a onclick="createnewmenu()" name="save_menu"
                                                                        id="save_menu_header"
                                                                        class="button button-primary menu-save">Vytvoriť
                                                                        menu</a>
                                                                </div>
                                                                @endif
                                                            </div>
                                                        ...
                                                        <div id="post-body">
                                                            <div id="post-body-content">
                                                                ...
                                                                @if(request()->has("menu"))
                                                                <h3>Menu štruktúra</h3>
                                                                <div class="drag-instructions post-body-plain" style="">
                                                                    <p>
                                                                    Každú položku umiestnite do požadovaného poradia. kliknite na šípku vpravo od položky, ak chcete zobraziť viac možností konfigurácie.
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <div class="drag-instructions post-body-plain" style="">
                                                                    <p>
                                                                    Zadajte názov a vyberte možnosť "Vytvoriť menu"
                                                                    </p>
                                                                </div>
                                                                @endif
                                                        ...
                                                        <div id="nav-menu-footer">
                                                            <div class="major-publishing-actions">
                                                                ...
                                                                <span class="delete-action"> <a
                                                                        ...
                                                                        onclick="deletemenu()"
                                                                        href="javascript:void(9)">Vymazať menu</a>
                                                                </span>
                                                                <div class="publishing-action">
