        ...
        s.Config.prototype.useTableProcessor = !0, s.Config.prototype.useExtraClassesOptions = !0, s.Config.prototype.controls.table = {
            ...
            return n(t, e), t.prototype.__deSelectAll = function (e, t) {
                ...
                if (n > i.NEARBY && l.width - n > i.NEARBY) this.__resizerHandler.style.display = "none";
                    ...
                    if (this.__resizerHandler.style.left = (n > i.NEARBY ? l.left + l.width : l.left) + s + "px", this.__resizerHandler.style.height = c.height + "px", this.__resizerHandler.style.top = c.top + "px", this.__resizerHandler.style.display = "block", n > i.NEARBY) this.__setWorkCell(o, !!a.Dom.next(o, t.isCell, o.parentNode) && null);
                    else {
