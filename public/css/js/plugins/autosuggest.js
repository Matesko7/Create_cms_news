...
_bsn.AutoSuggest = function (fldID, param)
{
	...
	if (!this.oP.noresults)									this.oP.noresults = 'Takýto klient sa v databázi nenachádza';
	...
	this.fld.onfocusin 		= function(ev){ return pointer.onKeyUp(ev); }
...
_bsn.AutoSuggest.prototype.createList = function(arr)
{
	...
	$('span.autosuggest span').fadeOut(100);
